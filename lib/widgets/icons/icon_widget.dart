...
class FUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if(width == null && height == null && color == null) {
      ...
      return SvgPicture.asset(file, height: height, color: color, package: 'fui_kit');
    } else if(height == null) {
      return SvgPicture.asset(file, width: width, color: color, package: 'fui_kit');
    } else if(color == null) {
      return SvgPicture.asset(file, width: width, height: height, package: 'fui_kit');
    } else {
      return SvgPicture.asset(file, width: width, height: height, color: color, package: 'fui_kit');
    }
  }
}